        ...
        <Box sx={{ flex: 1, overflow: 'auto', overflowX: 'hidden', WebkitOverflowScrolling: 'touch', '&::-webkit-scrollbar': { width: '8px' }, '&::-webkit-scrollbar-track': { background: '#f1f1f1' }, '&::-webkit-scrollbar-thumb': { background: '#888', borderRadius: '4px', '&:hover': { background: '#555' } }}>
          ...
          <TabPanel value={tabValue} index={1}>
            ...
            <FormControl fullWidth sx={{ mb: 2 }>
              ...
              <Select value={a11y.speechRate} onChange={(e) => a11y.setSpeechRate(e.target.value as number)}>
            ...
            <FormControl fullWidth sx={{ mb: 2 }>
              ...
              <Select value={a11y.speechVoice} onChange={(e) => a11y.setSpeechVoice(e.target.value as string)}>
          ...
          <TabPanel value={tabValue} index={4}>
            ...
            <FormControl fullWidth sx={{ mb: 2 }>
              ...
              <Slider value={a11y.whiteSpaceControl} onChange={(e, v) => a11y.setWhiteSpaceControl(v as number)} min={50} max={200} valueLabelDisplay="auto" />
            </FormControl>
          </TabPanel>
          ...
          <TabPanel value={tabValue} index={5}>
            ...
            <FormControl fullWidth sx={{ mb: 2 }>
              ...
              <Select value={a11y.buttonSize} onChange={(e) => a11y.setButtonSize(e.target.value as number)}>
                <MenuItem value={1}>Normal (1x)</MenuItem>
            ...
            <FormControl fullWidth sx={{ mb: 2 }>
              ...
              <Select value={a11y.clickDelay} onChange={(e) => a11y.setClickDelay(e.target.value as number)}>
          ...
          <TabPanel value={tabValue} index={6}>
            ...
            <FormControl fullWidth sx={{ mb: 2 }>
              ...
              <Select value={a11y.timeFormat} onChange={(e) => a11y.setTimeFormat(e.target.value as string)}>
          ...
          <TabPanel value={tabValue} index={8}>
            ...
            <FormControl fullWidth sx={{ mb: 2 }>
              ...
              <Slider value={a11y.volumeControl} onChange={(e, v) => a11y.setVolumeControl(v as number)} min={0} max={100} valueLabelDisplay="auto" />
            </FormControl>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }>
          ...
          <TabPanel value={tabValue} index={9}>
            ...
            <FormControl fullWidth sx={{ mb: 2 }>
              ...
              <Slider value={a11y.magnifierZoom} onChange={(e, v) => a11y.setMagnifierZoom(v as number)} min={2} max={10} step={1} marks valueLabelDisplay="auto" />
            </FormControl>
            <Divider sx={{ my: 3 } />
            ...
            {a11y.profiles.filter(p => p.isPreset).map(profile => (
              <Button key={profile.id} fullWidth variant="outlined" onClick={(e) => a11y.loadProfile(profile.id);} sx={{ mb: 1, justifyContent: 'flex-start', textAlign: 'left'}>
                <Box>
